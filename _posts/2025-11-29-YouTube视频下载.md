...
# --- SEO 优化部分 ---
# 自动提取文章核心内容作为搜索摘要
description: "本文介绍了在 Windows 上使用 yt-dlp 命令行工具下载网站视频，包含了自定义画质选择及使用 FFmpeg 合并音视频的完整操作教程。"

# 选取文章中的第一张图作为封面/预览图
image:
  path: https://shiguangtuku.dpdns.org/file/AgACAgUAAyEGAATAfiiVAAMUaS11AAGyU1OhaRwphhMbIziCs2unAAIcDWsbzrhoVS4XLe5IBYmWAQADAgADeQADNgQ.png
---
